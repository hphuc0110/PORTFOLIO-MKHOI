...
export default function Section6() {
  ...
  return (
    <section
      ref={ref}
      className="snap-start snap-always min-h-screen relative bg-[url(/img/dashboard/bgsection6.png)] bg-cover bg-center pt-32 px-16 xl:px-24 pb-12                                                                                       overflow-hidden transition-all"
    >
